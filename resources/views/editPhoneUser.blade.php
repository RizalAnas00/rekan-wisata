...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="container mx-auto p-4 md:p-8">
        <div class="bg-white p-6 md:p-10 rounded-lg shadow-lg">
            ...
            <h2 class="text-3xl font-bold text-center text-[#606c38] mb-6">Edit Phone Number</h2>
            ...
            <form action="{{ route('profile.updatePhoneNumber') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label class="block text-gray-700 font-semibold mb-2" for="phone_number">New Phone Number:</label>
                    <input type="text" name="phone_number" id="phone_number" class="bg-amber-50 text-gray-800 w-full px-2 py-2 rounded-2xl border-2 border-lime-950 shadow-sm" value="{{ old('email') }}" required>
                </div>
                <div class="mb-4">
